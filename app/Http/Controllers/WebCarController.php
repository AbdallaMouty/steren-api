...
class WebCarController extends Controller
{
    ...
    public function destroy(Car $car)
    {
        ...
        return redirect()->route('listings')->with('success', 'Car deleted successfully.');
    }
    ...
    public function approve(Car $car)
    {
        ...
        return redirect()->route('listings')->with('success', 'Car approved successfully.');
    }

    public function pause(Car $car)
    {
        $car->status           = 'paused';
        $car->rejection_reason = '';
        $car->save();

        return redirect()->route('listings')->with('success', 'Car paused successfully.');
    }

    public function boost(Car $car)
    {
        $car->status           = 'boosted';
        $car->rejection_reason = '';
        $car->save();

        return redirect()->route('listings')->with('success', 'Car boosted successfully.');
    }
    ...
    public function sold(Car $car)
    {
        ...
        return redirect()->route('listings')->with('success', 'Car status set to sold successfully.');
    }
    ...
    public function reject(Request $request, Car $car)
    {
        ...
        $car->status           = 'rejected';
        $car->rejection_reason = $request->input('rejection_reason') || 'reason';
        $car->save();

        return redirect()->route('listings')->with('success', 'Car rejected successfully.');
    }

    public function resetStatus(Request $request, Car $car)
    {
        if ($car->status === 'pending') {
            return redirect()->route('listings')->withErrors([
                'message' => 'Car is already pending.',
            ]);
        }
        ...
        return redirect()->route('listings')->with('success', 'Car reset successfully.');
    }
}
